...
pub const MODULE_DIR: &str = concatcp!("/data/local/", "mods/");
pub const MODULE_IMG: &str = concatcp!(WORKING_DIR, "mods.img");
pub const MODULE_UPDATE_IMG: &str = concatcp!(WORKING_DIR, "mods_update.img");

pub const MODULE_UPDATE_TMP_IMG: &str = concatcp!(WORKING_DIR, "update_tmp.img");

// warning: this directory should not change, or you need to change the code in module_installer.sh!!!
pub const MODULE_UPDATE_TMP_DIR: &str = concatcp!(ADB_DIR, "mods_update/");
